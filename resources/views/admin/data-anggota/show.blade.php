    ...
    <main class="content">
        ...
        <section class="detail-card member-detail-card">
            <div class="detail-title">
                <a href="{{ route('admin.data-anggota') }}">‹</a>
                <h2>{{ $member->nama }}</h2>
            </div>
            ...
            <form method="POST" action="{{ route('admin.data-anggota.update', $member->id) }}">
                ...
                <div class="form-grid member-form-grid">
                    ...
                    <div class="field full">
                        ...
                        <input type="text" value="{{ str_pad($member->id, 4, '0', STR_PAD_LEFT) }}MPN{{ $member->created_at->format('Y') }}" readonly>
                    </div>

                    <div class="field full">
                        <label>Jenis Keanggotaan</label>
                        <input type="text" name="asal_alamat" value="{{ $member->asal_alamat ?? 'Umum' }}" readonly>
                    </div>
                    ...
                    <div class="field full">
                        ...
                        <input type="text" name="no_identitas" value="{{ $member->no_identitas }}" readonly>
                    </div>
