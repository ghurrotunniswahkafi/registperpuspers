...
<div class="card">
    ...
    <div class="form-row">
        <div class="form-group full {{ $errors->has('nama') ? 'error' : '' }}">
            ...
            <input type="text" name="nama" placeholder="Nama lengkap sesuai kartu identitas" value="{{ old('nama') }}" style="{{ $errors->has('nama') ? 'border-color: #c33;' : '' }}">
            @if ($errors->has('nama'))
                <small style="color: #c33;">{{ $errors->first('nama') }}</small>
            @endif
        </div>
    </div>
    ...
    <div id="pengesahan-form" style="display: none;">
        ...
        <div class="form-row">
            ...
            <div class="form-group {{ $errors->has('pengesahan_no_hp') ? 'error' : '' }}">
                <label>No. Telp/HP</label>
                <input type="text" name="pengesahan_no_hp" placeholder="No. telp/hp pengesah" value="{{ old('pengesahan_no_hp') }}" style="{{ $errors->has('pengesahan_no_hp') ? 'border-color: #c33;' : '' }}">
                @if ($errors->has('pengesahan_no_hp'))
                    <small style="color: #c33;">{{ $errors->first('pengesahan_no_hp') }}</small>
                @endif
            </div>
        </div>
        <div class="form-row">
    ...
    <div class="form-row">
        ...
        <div class="form-group {{ $errors->has('tanggal_lahir') ? 'error' : '' }}">
            ...
            <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" style="{{ $errors->has('tanggal_lahir') ? 'border-color: #c33;' : '' }}">
    ...
    <div class="form-row">
        <div class="form-group {{ $errors->has('no_hp') ? 'error' : '' }}">
            ...
            <input type="text" name="no_hp" placeholder="08xxxxxxxxxx" value="{{ old('no_hp') }}" style="{{ $errors->has('no_hp') ? 'border-color: #c33;' : '' }}">
            @if ($errors->has('no_hp'))
    ...
    <!-- FOTO FORMAL -->
    <p>Foto Formal {{ $errors->has('foto') ? '<span style="color: #c33;">*Required</span>' : '' }}</p>
    <div class="upload-box" style="{{ $errors->has('foto') ? 'border-color: #c33; background-color: #fee;' : '' }}">
        ...
        @if ($errors->has('foto'))
            <small style="color: #c33; display: block;">{{ $errors->first('foto') }}</small>
        @endif
        <input type="file" name="foto" id="foto">
    </div>

    <!-- FOTO KTP -->
    <p>Foto KTP {{ $errors->has('ktp') ? '<span style="color: #c33;">*Required</span>' : '' }}</p>
    <div class="upload-box" style="{{ $errors->has('ktp') ? 'border-color: #c33; background-color: #fee;' : '' }}">
        ...
        @if ($errors->has('ktp'))
            <small style="color: #c33; display: block;">{{ $errors->first('ktp') }}</small>
        @endif
